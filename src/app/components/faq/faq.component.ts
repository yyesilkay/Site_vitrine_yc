...
export class FaqComponent {
  ...
  faqs =[
...

    {
      ...
      answer: 'Pour obtenir un devis, rendez-vous sur notre <a href="/estimate_request">page dédiée</a>. Soyez le plus précis possible dans la description de votre besoin pour recevoir une réponse rapide et adaptée.',
      isOpen: false
    },
